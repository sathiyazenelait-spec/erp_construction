...
const reportList = [
  { name: "Monthly Sales Progress Report - May 2025", type: "PDF", size: "3.5 MB", date: "28 May 2025" },
  { name: "Tender Participation Log - May 2025", type: "XLSX", size: "8.2 MB", date: "27 May 2025" },
  { name: "Marketing Spend & Leads Analysis - Q1 2025", type: "PDF", size: "5.4 MB", date: "20 May 2025" },
  { name: "Signed Contracts Ledger - Q1 2025", type: "PDF", size: "4.1 MB", date: "15 May 2025" },
];
...
export default function ReportsAnalytics() {
  return (
    <div className="space-y-6">
      {/* Title */}
      <div>
        <h2 className="text-xl font-bold text-white tracking-wide">10. REPORTS & ANALYTICS</h2>
        <p className="text-xs text-slate-400">View and download sales pipeline spreadsheets, tender participation records, and marketing spent analytics</p>
      </div>
      ...
      <AIAssistantBar suggestions={["Export custom reports", "Opportunities reports history", "SWOT audits archive"]} />
    </div>
  );
}
