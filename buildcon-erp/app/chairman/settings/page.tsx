...
import { User, Shield, Bell, Key, Database, Save, Check } from "lucide-react";
import AIAssistantBar from "@/components/AIAssistantBar";

export default function Settings() {
  const [profile, setProfile] = useState({
    name: "Rajesh Kumar",
    email: "chairman@buildcon.com",
    phone: "+91 9876543210",
    role: "Chairman",
  });
    ...
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="bg-[#111A2E] border border-slate-800 rounded-xl p-5 lg:col-span-3">
          <h3 className="text-sm font-semibold text-slate-200 mb-4 pb-2 border-b border-slate-800">Profile Settings</h3>
      ...
      <AIAssistantBar suggestions={["MFA setup logs", "System preferences", "Theme customization settings", "Notification alerts settings"]} />
    </div>
  );
}
