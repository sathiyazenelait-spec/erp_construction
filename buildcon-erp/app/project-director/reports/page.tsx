...
const reportList = [
  { name: "Monthly Project Progress Report - May 2025", type: "PDF", size: "4.8 MB", date: "28 May 2025" },
  { name: "QC NCR Backlog Summary - May 2025", type: "XLSX", size: "2.5 MB", date: "27 May 2025" },
  { name: "Labour Strength Allocation Ledger - May 2025", type: "PDF", size: "3.2 MB", date: "20 May 2025" },
  { name: "Safety Audits Archive - Q1 2025", type: "ZIP", size: "15.4 MB", date: "15 May 2025" },
];
...
export default function ReportsAnalytics() {
  return (
    <div className="space-y-6">
      {/* Title */}
      <div>
        <h2 className="text-xl font-bold text-white tracking-wide">12. REPORTS & ANALYTICS</h2>
        <p className="text-xs text-slate-400">View and download project operations, safety records, and quality compliance logs</p>
      </div>
