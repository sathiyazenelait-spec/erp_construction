...
@Service
public class BusinessDirectorServiceImpl implements BusinessDirectorService {

    @Autowired
    private BusinessDirectorRepository repository;

    @Autowired
    private PasswordEncoder encoder;

    @Override
    public BusinessDirector register(GenericSignupRequest request) {
        ...
        BusinessDirector item = new BusinessDirector(
            request.getUsername(),
            request.getEmail(),
        ...
        item.setAvatarInitials(initials.isEmpty() ? "BD" : initials);
