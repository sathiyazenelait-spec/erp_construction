...
import com.buildcon.erp.repository.SalesExecutiveRepository;
...
public class SalesExecutiveServiceImpl implements SalesExecutiveService {
    ...
    @Autowired
    private SalesExecutiveRepository repository;

    @Autowired
    private PasswordEncoder encoder;

    @Override
    public SalesExecutive register(GenericSignupRequest request) {
        ...
        SalesExecutive item = new SalesExecutive(
            request.getUsername(),
            request.getEmail(),
