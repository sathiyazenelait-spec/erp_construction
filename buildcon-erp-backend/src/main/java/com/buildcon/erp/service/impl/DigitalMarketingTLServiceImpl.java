...
import com.buildcon.erp.repository.DigitalMarketingTLRepository;
...
@Service
public class DigitalMarketingTLServiceImpl implements DigitalMarketingTLService {

    @Autowired
    private DigitalMarketingTLRepository repository;

    @Autowired
    private PasswordEncoder encoder;

    @Override
    public DigitalMarketingTL register(GenericSignupRequest request) {
        ...
        DigitalMarketingTL item = new DigitalMarketingTL(
            request.getUsername(),
            request.getEmail(),
